...
import csv
import logging
logging.basicConfig(filename='230712.log', encoding='utf-8', level=logging.INFO)
...
def writewrite(lists):
    try:
        with open('P-1_Q1x_Q2X.csv', 'a+', newline="") as output_file:
...
if __name__ == '__main__':
    cloudpss.setToken('eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NjA2LCJ1c2VybmFtZSI6InNvMW9tb24iLCJzY29wZXMiOltdLCJ0eXBlIjoiYXBwbHkiLCJleHAiOjE3MTk5MDMwOTksImlhdCI6MTY4ODc5OTA5OX0.uMQBNVz9h1l0RBo5NsN1kgcq9KPt_lMwdZZL0_TLf2AinPW0w5Y88OfTQ4jqVXD_I1yVAb7EkUzu_GIkWXwhPw')
    ### 获取指定 rid 的项目
    os.environ['CLOUDPSS_API_URL'] = 'https://internal.cloudpss.net/'
    model = cloudpss.Model.fetch('model/so1omon/verif_VdcIq')
